...
| `OPENWEATHER_API_KEY`                                                                                  | For weather                | Server-side klíč pro živé počasí na stránkách Počasí (`src/lib/weather.ts`, nikdy nejde do prohlížeče). Účet potřebuje předplatné **One Call 3.0** (řádek _Base plan_): prvních 1 000 volání denně zdarma, další zpoplatněné — proto má účet nastavený tvrdý strop 1 000/den. Bez předplatného se web přepne na bezplatné endpointy (6denní předpověď).                                                                                                                                                       |
...
- Zdroj: **OpenWeather One Call 3.0** (`OPENWEATHER_API_KEY`, účet s tarifem
  _Base plan_; prvních **1 000 volání/den zdarma**, další 0,14 EUR/100 — proto
