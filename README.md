...
| `OPENWEATHER_API_KEY`                                                                                  | For weather                | Server-side klíč pro živé počasí na stránkách Počasí (`src/lib/weather.ts`, nikdy nejde do prohlížeče). Účet potřebuje předplatné **One Call 3.0** — tarif _Base_ se stropem 1 000 volání/den je zdarma; bez předplatného se web přepne na bezplatné endpointy (6denní předpověď).                                                                                                                                                                                                                            |
...
- Zdroj: **OpenWeather One Call 3.0** (`OPENWEATHER_API_KEY`, účet s tarifem
  _Base_ a stropem **1 000 volání/den** = trvale zdarma; strop se nastavuje
