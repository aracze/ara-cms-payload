...
// Výška se zaokrouhluje na CELÝCH 17 px displeje (v šabloně height="17"),
// @2x tedy 34 px — kdyby se PNG nedělilo dvěma přesně, klient by logo
// o půl pixelu natáhl.
const LOGO_WIDTH = 168
const LOGO_HEIGHT = 2 * Math.round(((263.56 / 1335.07) * LOGO_WIDTH) / 2)
